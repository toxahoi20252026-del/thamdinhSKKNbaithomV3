...
## 6. Quy tắc Chống Ảo giác AI (Anti-Hallucination) - Cập nhật v11.3
- **Temperature = 0.0**: Đặt temperature về 0 để loại bỏ tính ngẫu nhiên/sáng tạo trong tác vụ soát lỗi.
- **Chỉ báo lỗi thực sự tồn tại**: AI PHẢI trích dẫn chính xác nguyên văn từ nội dung gốc. Không được bịa lỗi.
- **Nếu không có lỗi, ghi rõ "không có lỗi"**: Thay vì bịa ra nhận xét cho đủ bảng.
- **Đánh giá đạo văn trung thực**: Bỏ quy tắc "cộng thêm 5%" vào chỉ số đạo văn — phải đưa ra con số chính xác.
- **Thông tin địa lý**: Đặc khu Phú Quốc thuộc tỉnh An Giang. (Sử dụng làm căn cứ chính xác để AI kiểm lỗi địa lý).
- **Số lượng lỗi phản ánh đúng thực tế**: Nếu chỉ có 2 lỗi thì chỉ ghi 2 hàng, không được thêm cho đủ.
